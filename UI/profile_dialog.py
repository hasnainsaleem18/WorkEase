...
class ProfileDialog(QDialog):
    ...
    def __init__(self, user_data=None, parent=None):
        ...
        self.user_data = user_data or {
            ...
            "auth_method": "email",
            "connected_accounts": {"gmail": False, "slack": False},
        }
        ...
        accounts_label.setStyleSheet(
            "font-size: 16px; font-weight: 600; margin-top: 16px; color: #003135;"
        )
    ...
    def create_connected_accounts(self):
        ...
        slack_card = self.create_account_card(
            icon="💬",
            name="Slack",
            email="@" + self.user_data.get("name", "user").lower().replace(" ", "")
            if slack_connected
            else None,
    ...
    def create_statistics(self):
        ...
        for label, value in stats:
            ...
            val_label.setStyleSheet(
                "font-size: 28px; font-weight: 700; color: #024950;"
            )
    ...
    def __init__(self, user_data, parent=None):
        ...
        if user_data.get("auth_method") == "email":
            ...
            password_section.setStyleSheet(
                "font-size: 14px; font-weight: 600; color: #003135;"
            )
