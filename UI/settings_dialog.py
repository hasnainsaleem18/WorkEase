...
class SettingsDialog(QDialog):
    ...
    def create_gmail_integration_card(self):
        ...
        client_id_label.setStyleSheet(
            "font-size: 12px; font-weight: 500; color: #024950;"
        )
        ...
        scopes_label.setStyleSheet(
            "font-size: 12px; font-weight: 600; color: #024950; margin-top: 8px;"
        )
        ...
        connect_btn.clicked.connect(
            lambda: self.handle_gmail_connect(client_id_input, client_secret_input)
        )
    ...
    def create_slack_integration_card(self):
        ...
        connect_btn.clicked.connect(
            lambda: self.handle_slack_connect(
                token_input, app_token_input, signing_input
            )
        )
