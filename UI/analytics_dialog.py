...
class AnalyticsDialog(QDialog):
    def __init__(self, parent=None):
        ...
        priority_label.setStyleSheet("font-size: 18px; font-weight: 600; margin-top: 16px; color: #003135;")
        ...
        senders_label.setStyleSheet("font-size: 18px; font-weight: 600; margin-top: 16px; color: #003135;")
    ...
    def create_stat_card(self, title, value, subtitle):
        ...
        value_label.setStyleSheet("font-size: 32px; font-weight: 700; color: #0FA4AF; margin: 8px 0;")
